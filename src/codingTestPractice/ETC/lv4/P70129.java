...
public class P70129 {
    public static void main(String[] args) {
        ...
        System.out.println("Arrays.toString(solution(s)) = " + Arrays.toString(solution(s)));
    }
    public static int[] solution(String s) {
        ...
        while(true) {
            ...
            // 0을 제거하기
            String newS = sBinary.replace("0", "");

            // 2진법으로 표현
            sBinary = Integer.toBinaryString(newS.length());

            binaryCount++;
            if(sBinary.equals("1")) break;
